#!/bin/bash -l
#SBATCH --job-name=generate-aec-17 # give a name to the job
...
# run
srun matlab -nodisplay -r "participant = 'MDFA17'; step_1_5_generate_aec_matrix" # will run on at most 40 cores
