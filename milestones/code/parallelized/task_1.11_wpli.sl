#!/bin/bash -l
#SBATCH --job-name=generate-wpli-11 # give a name to the job
...
#SBATCH --cpus-per-task=10 # adjust if parallel commands
...
# run
srun matlab -nodisplay -r "participant = 'MDFA11'; generate_wpli" # will run on at most 40 cores
