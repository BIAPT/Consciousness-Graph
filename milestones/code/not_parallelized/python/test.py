...
output_path = "C:/Users/rapha/OneDrive/Documents/School/Research/test_python/results"
name = "MDFA10"
sessions = ["T1"]
states = ['baseline']
...
#calculate wpli
mdfa10.calculate_wpli(fmin = 8, fmax = 13, channel_order_path = channel_order_path, n_windows = 291)
