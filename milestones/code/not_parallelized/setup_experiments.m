...
participants = {'MDFA03', 'MDFA05', 'MDFA05', 'MDFA06', 'MDFA07', 'MDFA10', 'MDFA11', 'MDFA12', 'MDFA15', 'MDFA17'};
...
graph_param = struct();
graph_param.threshold = 0.41; %zeros(length(participants), length(states));%[0.66;0.48], 0.41, 0.57, 
