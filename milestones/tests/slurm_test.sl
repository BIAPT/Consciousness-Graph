...
#SBATCH --time=0-00:10:00 # adjust to match the time required for the job, (D-HH:MM:SS) be as accurate ap
...
# run
srun matlab -nodisplay -r "participant = 'MDFA10'; sample" # will run on at most 40 cores
